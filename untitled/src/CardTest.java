...
class Card5 {
    ...
    static int height = 250;         // Card 인스턴스인 c1과 c2는 클래스 변수인 width와 height을 공유한다.
}                                    //때문에 c1의 width와 height를 변경하면 c2의 width와 height 값도 바뀐 것과 같은 결과를 얻는다.
//to_ Card.width, c1.width, c2.width는 모두 같은 저장공간을 참조하므로 항상 같은 값을 갖게 된다.
